"""X25519 diffie hellman key exchange and secret generation this module has a pure python montgomery ladder implementation that i have coded myself"""
import os
...
def _montgomery_ladder(scalar: int, u: int) -> int:
    """Montgomery ladder for X25519 curve where v^2 = U^3 = 486662u^2  """
